...
CH_2_taxa <- assignTaxonomy(CH_2_seqtab.nonchim, "~/tax/silva_nr_v132_train_set.fa.gz", multithread=TRUE)

CH_2_taxa <- addSpecies(CH_2_taxa, "~/tax/silva_species_assignment_v132.fa.gz")

write.csv(cbind(t(CH_2_seqtab.nonchim), CH_2_taxa), "path/to/seqtab.csv", quote=FALSE)
